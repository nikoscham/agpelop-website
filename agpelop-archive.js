const bridgeData = {
  ...
  "gefyri-8": {
    ...
    links:
      'Σχετικό άρθρο στο blog του Α.Γ.Π.: <a href="http://agpelop.blogspot.com/2017/11/blog-post.html?spref=bl?spref=bl" target="_blank">Μεγάλο Πετραλέϊκο γεφύρι ή γεφύρι στο μύλo Koυτσόπουλου. Δίβρη Ηλείας.</a>',
  },
};
