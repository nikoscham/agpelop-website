const bridgeData = {
  "gefyri-1": {
    ...
    builder: "Άγνωστος",
    description:
      "Αποτελείται από πέντε άνισα τόξα με ορθογώνια ανακουφιστικά ανοίγματα, τρία επάλληλα καταστρώματα, έχει ύψος 12 μέτρα, μήκος 50 και το μεγαλύτερο τόξο έχει άνοιγμα 8,75 μέτρα.",
    links:
  ...
  "gefyri-2": {
    ...
    builder: "Άγνωστος",
    description: "-",
    links: 'Σχετικό άρθρο στο blog: <a href="http://agpelop.blogspot.com/2021/10/blog-post.html" target="_blank">Το τρικέφαλο γεφύρι της Μαυροζούμενας</a>',
  },
  "gefyri-3": {
    ...
    links: 'Σχετικό άρθρο στο blog: <a href="http://agpelop.blogspot.com/2015/01/blog-post.html?spref=bl" target="_blank">Τουρκογέφυρο στην Πρόσυμνα Αργολίδας</a>',
  },
  "gefyri-4": {
    ...
    links: 'Σχετικό άρθρο στο blog: <a href="http://agpelop.blogspot.com/2016/10/blog-post_10.html?spref=bl" target="_blank">Γεφύρι στη θέση “Δομοκός” ή Βιδιακίτικο γεφύρι</a>',
  },
  "gefyri-5": {
    ...
    builder:
      "Των τεσσάρων πρώτων τόξων άγνωστοι, το πέμπτο ο Λαγκαδινός Ανδρικόπουλος",
    description:
    ...
    links: 'Σχετικό άρθρο στο blog: <a href="http://agpelop.blogspot.com/2019/09/blog-post.html" target="_blank">Το γεφύρι της "Κυράς" στον Λάδωνα</a>',
  },
  "gefyri-6": {
    ...
    links: 'Σχετικό άρθρο στο blog: <a href="http://agpelop.blogspot.com/2013/01/blog-post_27.html?spref=tw" target="_blank">Γεφύρι Τσερχοτάμπεη στο Λάδωνα</a>',
  },
};
